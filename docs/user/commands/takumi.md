...
Takumi is an AI-aware, language-agnostic workspace manager that works with any
...
* [takumi lint](takumi_lint.md)	 - Run lint phase for packages
* [takumi mcp](takumi_mcp.md)	 - Model Context Protocol integration
* [takumi release](takumi_release.md)	 - Run release phase for packages
...
* [takumi run](takumi_run.md)	 - Run any named phase (alias — you can also use 'takumi <phase>' directly)
