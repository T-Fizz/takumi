...
- [`takumi lint`](commands/takumi_lint.md) — Run lint phase for packages
...
- [`takumi release`](commands/takumi_release.md) — Run release phase for packages
...
- [`takumi run`](commands/takumi_run.md) — Run any named phase (alias — you can also use 'takumi <phase>' directly)
